...
@click.option("-p", "--no-emit-project", is_flag=True)
def run_solver(project_dir, output_dir, no_suppress, no_emit_project):
    ...
    solver.run_solver_loop(project_dir, wheels_dir, no_suppress, no_emit_project)
